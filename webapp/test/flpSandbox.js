		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sales Order",
									"targetURL": "#comexamplesalesorderdemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexamplesalesorderdemo-display": {
								"semanticObject": "comexamplesalesorderdemo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.example.salesorderdemo",
									"url": sap.ui.require.toUrl("com/example/salesorderdemo")
								}
							}
						}
					}
